...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
      e.preventDefault();
      const response = await loginRequest.submit({ username, password });
  ...
  // Update the input classes to include border styles
        ...
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
          <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
            ...
            <div className="hidden lg:relative lg:block lg:p-12">
              ...
              Visualize Your Ski Journey with Eye in the Ski ⛷️
              </h2>
          ...
          >
            <div className="max-w-xl lg:max-w-3xl">
              ...
              <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-6 gap-12">
